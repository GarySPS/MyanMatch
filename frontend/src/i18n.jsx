...
const STRINGS = {
  ...
  "terms": {
    ...
    "boost.desc":
      "🚀 Boost puts you on Users Of The Day for 24 hours and highlights your profile in Explore.",
    "boost.price": "Price",
    ...
    "pricing.refundNote":
      "For your transaction safety: if something goes wrong and you don’t receive your benefits, we’ll return your coins.",
    ...
    "verify.warn.identical":
      "It looks like both selfies are identical. Please retake one with a different pose.",
    ...
    "verify.list.useOnly":
      "We only use these images for verification and then archive them securely.",
    ...
    "market.deposit.refundBox":
      "If something goes wrong and you don’t receive coins, we’ll refund your payment.",
    ...
    "market.deposit.msgSubmitted":
      "Thanks! Proof submitted. We’ll credit coins after review.",
    ...
    "market.deposit.footerNote":
      "Upload the screenshot + Tx ID after transfer. Admin reviews and credits coins.",
    ...
    "market.withdraw.ruleText":
      "Minimum withdraw: {min} coins. You must keep at least {keep} coins in your balance.",
    "market.withdraw.request": "Request Withdraw",
    "market.withdraw.footer":
      "Withdrawals are manual and reviewed by admin. No extra fee.",
    ...
    "market.withdraw.maxAmount":
      "You can withdraw up to {max} coins. You must keep {keep} coins in your balance.",
    ...
    "market.guide.item3":
      "Use Buy/Sell tabs for inventory management—sell one or sell all quickly.",
    ...
    "matches.empty.desc":
      "Boost your profile to appear at the top and get more attention.",
    ...
    "explore.subtitle":
      "Handpicked standouts boosted to the top. Send a gift to make a memorable first impression.",
    ...
    "explore.empty.desc":
      "Boost your profile to get premium placement here and more views.",
    ...
    "home.empty.desc":
      "Check back later or boost your profile to get more visibility and fresh connections.",
    "home.noname": "No Name",
    ...
    "delete.readFirst.body":
      "Deleting your account removes your profile, messages, likes, gifts, boosts, and all other data from MyanMatch. There is no way to recover it later.",
    ...
    "gender.subtitle":
      "MyanMatch matches are grouped by these three genders. You can add more about your gender later.",
    ...
    "loc.pop.unsupported.msg":
      "Your browser doesn’t support location. Please update your browser or enable it in settings.",
    ...
    "loc.pop.fetch.msg":
      "Check your internet connection and allow location access, then try again.",
    ...
    "prefs.lock.desc":
      "Unlock advanced filters like distance, habits, religion, politics, family plans, and more.",
    ...
    "prefs.opt.relationship.long_term_relationship_open_to_short":
      "Long-term relationship, open to short",
    "prefs.opt.relationship.short_term_relationship_open_to_long":
    ...
    edit: {
      title: "Edit Profile",
      subtitle:
        "Tune your profile to find better matches. Changes are saved to your account.",
      save: "Save",
      saving: "Saving…",
    ...
    download: {
      ...
      androidTip:
        "Tip: Use Chrome on Android. If the button doesn’t appear, open the ⋮ menu and tap “Install app” or “Add to Home screen”.",
      ios: "iOS (iPhone)",
  ...
  my: {
    ...
    "nav.plan": "အကောင့် အဆင့်မြင့်တင်ခြင်း",
    ...
    "boost.desc":
      "🚀 Boost တင်ခြင်းဖြင့် သင့်ကို Users Of The Day တွင် ၂၄ နာရီထိ ထည့်သွင်းပြီးထင်ရှားစေပါမည်။",
    ...
    "pricing.refundNote":
      "လှုံခြုံစိတ်ချသောဝယ်ယူမှု။ အဆင့်မြင့်တင်ခြင်းများ မရရှိပါက coins ကို ပြန်အမ်းပေးပါမယ်ရှင့်။",
    ...
    "pricing.msg.notEnough": "coins မလုံလောက်ပါ။ {need} လိုအပ်သည် (သင့်မှာ {have} ရှိသည်)။",
    ...
    "verify.title": "အကောင့်စစ်မှန်ကြောင်း မှတ်ပုံတင်ခြင်း",
    "verify.subtitle":
      "လုံခြုံမှုအတွက် Selfie ၂ပုံ လိုအပ်သည် — အများယုံကြည်စိတ်ချရကြစေသော MyanMatch အကောင့်ကို အသုံးပြုပါရှင့်။",
    ...
    "verify.badgeNote":
      "သတိပြုရန်။ မှတ်ပုံတင်ထားသော မိမိ၏ ပရိုဖိုင်ဓာတ်ပုံ ပြောင်းလဲလျှင် အတည်ပြုအမှန်ခြစ် ဖယ်ရှားခံရမယ်ရှင်။",
    "verify.selfieA": "Selfie A",
    "verify.selfieB": "Selfie B",
    "verify.tapToTake": "နှိပ်၍ selfie ဓာတ်ပုံ တင်ပါ",
    "verify.remove": "ဖျက်ရန်",
    "verify.warn.identical":
      "Selfie နှစ်ပုံသည် တူညီနေသည်။ ပိုစ်စ် ပြောင်းပြီး တစ်ပုံကို ပြန်ရိုက်ပေးပါရှင်။",
    "verify.btn.submit": "စစ်ဆေးရန် စာရင်းသွင်းမည်",
    "verify.btn.submitting": "စာရင်းသွင်းနေသည်…",
    "verify.btn.pending": "စစ်ဆေးနေဆဲ…",
    "verify.tip":
      "အကြံပြုချက် — မျက်နှာ ရှင်းလင်းပြီး & မီးအလင်းကောင်းစွာသုံးပါ ⇒ အတည်ပြု မှုအမြန်ရနိုင်သည်ရှင့်။",
    ...
    "verify.list.useOnly":
      "ဤဓာတ်ပုံများကို အတည်ပြုရုံအတွက်သာ အသုံးပြုပြီး လုံခြုံစွာ သိမ်းဆည်းထားပါတယ်ရှင့်။",
    "verify.msg.submitted":
      "တင်ပြီးပါပြီ! မကြာမီ စစ်ဆေးပေးမည် — အတည်ပြုပြီးနောက် အမှန်ခြစ် ပေါ်လာပါမယ်ရှင်။",
    "verify.err.signInFirst": "အရင် စာရင်းဝင်ပေးပါ။",
    "verify.err.needBoth": "Selfie ၂ပုံလုံး ထည့်ပေးပါ။",
    "verify.err.identical":
      "Selfie A နှင့် Selfie B တူညီနေပါသည် — ပိုစ်စ် မတူပဲ တစ်ပုံကို ပြန်ရိုက်ပေးပါရှင်။",
    ...
    "verify.denied.default":
      "သင့် အတည်ပြုမှုကို ခွင့်ပြုမပေးနိုင်ပါ။ ပိုထင်ရှားသည့် ဓာတ်ပုံများနှင့် ထပ်မံကြိုးစားပေးပါရှင်။",
    "verify.denied.ok": "OK",
    ...
    "market.deposit.refundBox":
      "အခက်အခဲတစ်စုံတစ်ရာကြောင့် coins မရရှိပါက သက်ဆိုင်ရာပမာဏ ပြန်အမ်းပေးပါမယ်ရှင့်။",
    ...
    "market.deposit.footerNote":
      "ငွေလွှဲပြီးနောက် screenshot + Tx ID ကို တင်ပါ။ အချိန်တိုအတွင်း coins ရရှိပါမည်ရှင်။",
    ...
    "market.withdraw.ruleText":
      "အနည်းဆုံး ထုတ်ယူမှု {min} coins — လက်ကျန်တွင် အနည်းဆုံး {keep} coins ကျန်ရှိရမည်ရှင့်။",
    "market.withdraw.request": "ထုတ်ယူရန် စာရင်းတင်မည်",
    "market.withdraw.footer":
      "ထုတ်ယူမှုများကို မှားယွင်းမှုမရှိစေရန် သေချာစစ်ဆေးပါ, အချိန်တိုအတွင်းထုတ်ယူမှုပြီးဆုံးပါမည်ရှင့် ",
    ...
    "market.withdraw.maxAmount":
      "အများဆုံး {max} coins ထုတ်ယူနိုင်သည်။ လက်ကျန်တွင် {keep} coins ထားရှိရမည်ရှင့်။",
    ...
    "market.guide.item3":
      "ဝယ်မယ်/ရောင်းမယ် ဖြင့် စုစုပေါင်းကို စီမံခန့်ခွဲပါ — တစ်ခုချင်း/အားလုံး ရောင်းနိုင်သည်။",
    "market.guide.item4":
      "မှတ်တမ်း တွင် ငွေသွင်း/ငွေထုတ်/အဝယ်/အရောင်း များကို တွေ့နိုင်ပါသည်ရှင်။",
    ...
    "matches.empty.title":
      "လူကြီးမင်းသည်အကောင့်အသစ်ဖြစ်သောကြောင့်— စိတ်ဝင်စားသူရှာမတွေ့သေးပါရှင့်။",
    ...
    "matches.modal.desc":
      "သင်နှင့် {name} တို့ စိတ်ဝင်စားမှုတူညီကြပါသည်။ ၂ယောက်ကြားနားလည်မှုကိုအခုဖဲရှာဖွေလိုက်ပါရှင်",
    ...
    "explore.subtitle":
      "ယနေ့လူကြိုက်များသောပရိုဖိုင်များကို ဝင်ရောက်ကြည့်ရှုပြီးမိမိနှင့် ထပ်တူကျနိုင်သောသူကို ရှာဖွေနိုင်ပါပြီရှင်။ စိတ်ဝင်စားစေဖို့ ယခုဖဲ🎁နုတ်ဆက်လက်ဆောင်တစ်ခု ပို့လိုက်ပါနော်။",
    "explore.boostMe": "Boost",
    ...
    "explore.empty.title": "ယနေ့ ပထမဦးဆုံး ထင်ရှားသူ ဖြစ်လိုက်ပါရှင်",
    ...
    "home.empty.ribbon": "မကြာခင်ပြန်လာခဲ့ပါရှင့်",
    "home.empty.title": "ယခုပရိုဖိုင် မရှိတော့ပါ",
    "home.empty.desc":
      "ခဏစောင့်ဆိုင်းပြီး ပြန်လာကြည့်ပါ၊ သို့မဟုတ် ပရိုဖိုင်ကို Boost လုပ်ပြီး ပိုမိုထင်ရှားသူဖြစ်လိုက်ပါရှင့်။",
    ...
    "delete.readFirst.body":
      "အကောင့်ကို ပယ်ဖျက်ပါက မိမိ၏ ပရိုဖိုင်၊ စာများ၊ ကြိုက်နှစ်သက်မှုများ၊ လက်ဆောင်များ၊ Boost များနှင့် သက်ဆိုင်သော အချက်အလက်အားလုံးကို MyanMatch မှ ဖယ်ရှားမည်ဖြစ်ပါသည်။ နောက်မှ ပြန်လည်ရယူနိုင်မည် မဟုတ်ပါရှင့်။",
    ...
    "gender.subtitle":
      "MyanMatch တွင် လိင်အမျိုးအစား ၃ မျိုးအုပ်စုအဖြစ် တင်စားပြီး ကိုက်ညီမှုကို ထောက်ခံပေးထားပါတယ်ရှင့်။ နောက်တစ်ချိန်မှာ သင့်လိင်အမျိုးအစားအကြောင်း ပိုမိုအသေးစိတ် ထည့်နိုင်ပါတယ်ရှင့်။",
    ...
    "job.title": "သင့် တာဝန်ခန့်ထားမှု/ရာထူး ဘယ်ဟာလဲ?",
    ...
    "loc.pop.unsupported.msg":
      "သင်၏ ဘရောက်ဇာသည် တည်နေရာကို မပံ့ပိုးပါ။ အပ်ဒိတ်လုပ်ပါ သို့မဟုတ် ဆက်တင်တွင်ခွင့်ပြုပေးပါရှင့်။",
    ...
    "loc.pop.fetch.msg":
      "အင်တာနက်နှင့် တည်နေရာ ခွင့်ပြုချက်များကို စစ်ဆေးပြီး ပြန်ကြိုးစားပါရှင်။",
    ...
    "loc.pop.blocked.generic": "GPS တည်နေရာ မရရှိနိုင်ပါ။ ထပ်ကြိုးစားကြည့်ပါရှင်။",
    ...
    "prefs.lock.desc":
      "အကွာအဝေး၊ အသုံးအစွဲ၊ ကိုးကွယ်မှု၊ နိုင်ငံရေး၊ မိသားစုအစီအစဉ် စသည်တို့အပါအဝင် အဆင့်မြင့် filter များကို ဖွင့်နိုင်မည်။",
    ...
    "prefs.opt.relationship.long_term_relationship_open_to_short":
      "ရေရှည်ကာလ မျှော်လင့်ပေမယ့်၊ ရေတိုလည်း အဆင်ပြေ",
    "prefs.opt.relationship.short_term_relationship_open_to_long":
      "ရေတိုကာလ မျှော်လင့်ပေမယ့်၊ ရေရှည်လည်း အဆင်ပြေ",
    "prefs.opt.relationship.short_term_relationship": "အချိန်တို ဆက်ဆံရေး",
    "prefs.opt.relationship.friendship": "မိတ်ဆွေမှု",
    "prefs.opt.relationship.figuring_out_my_dating_goals":
      "တွေ့ဆုံရေး ရည်ရွယ်ချက်ကို စဉ်းစားနေဆဲ",
    ...
    edit: {
      ...
      subtitle:
        "ပိုမိုကိုက်ညီတဲ့ မိတ်ဆွေတွေကိုတွေ့ဖို့ ပရိုဖိုင်းကို အနည်းငယ်ညှိပေးပါ။ ပြောင်းလဲမှုတွေကို မှတ်တမ်းတင်ပေးထားပါတယ်။",
      save: "Save",
      saving: "သိမ်းနေသည်…",
    ...
    download: {
      ...
      androidTip:
        "အကြံပြုချက် - Android တွင် Chrome သုံးပါ။ Button မပေါ်ပါက ⋮ အပေါ်ဒေါင့် အစက်၃စက် menu ထဲမှ “Install app” သို့မဟုတ် “Add to Home screen” ကိုနှိပ်ပါ။",
      ios: "iOS (iPhone)",
      ...
      iosNote:
        "မှတ်ချက် — iOS တွင် Safari မှသာ တပ်ဆင်နိုင်သည်။ အခြား browser သုံးနေပါက Safari ဖြင့်ဖွင့်ပါ။",
    },
    msg: {
      alreadyInstalled: "✅ ဤစက်တွင် အက်ပ်တပ်ဆင်ပြီးသား ဖြစ်ပါသည်။",
      noPrompt:
        "ဘာမှ မဖြစ်လျှင် Android တွင် Chrome ဖြင့်ဖွင့်ပါ သို့မဟုတ် browser မီနူးမှ Home Screen သို့ ထည့်ရန်/Install app ကိုနှိပ်ပါ။",
