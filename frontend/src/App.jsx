...
import OnboardingRoute from "./OnboardingRoute"; // [!ADD!] Import your new guard component
import ProtectedAdminRoute from "./ProtectedAdminRoute";
import AdminDashboard from "./admin/AdminDashboard";
import { I18nProvider } from "./i18n";

// --- All your page imports remain the same ---
...
          {/* [!CRITICAL FIX!] Onboarding routes are now protected by your OnboardingRoute guard. */}
...
          {/* Protected routes for fully onboarded users */}
