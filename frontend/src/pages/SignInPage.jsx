// The new, corrected SignInPage.jsx
import { useEffect, useState } from "react";
import { useLocation, useNavigate } from "react-router-dom";
import { supabase } from "../supabaseClient";
import { useAuth } from "../context/AuthContext"; // <-- 1. Import the new hook
...
  const navigate = useNavigate();
  ...
  const { user, profile, loading: authLoading } = useAuth(); // <-- 2. Use our central auth state
...
  }
  ...
  // 3. REMOVED the old useEffect with onAuthStateChange and the ensureProfileAndCache function.
  // This new effect handles navigation reactively AFTER a user logs in.
  useEffect(() => {
