...
const OPTIONS = [
  { key: "children.opt.none", valueEn: "Don't have children" },
  { key: "children.opt.have", valueEn: "Have children" },
  { key: "children.opt.dog",  valueEn: "Have dog" },
  { key: "children.opt.cat",  valueEn: "Have cat" },
  { key: "children.opt.pet",  valueEn: "Have pet" },
  { key: "children.opt.na",   valueEn: "Prefer not to say" },
];
...
export default function ChildrenPage() {
  ...
  // store the English value so backend/data stays the same
  ...
  const handleNext = () => {
    ...
    navigate("/onboarding/family-plans");
  };
      ...
      <div className="relative bg-white/95 rounded-3xl shadow-2xl max-w-md w-full px-7 py-10 flex flex-col items-center">
        ...
        <div className="flex items-center justify-center w-full mb-7">
          <div className="w-7 h-7 rounded-full border-2 border-[#6e2263] flex items-center justify-center bg-white shadow">
            <HiOutlineShoppingCart className="w-5 h-5 text-[#6e2263]" />
          </div>
        ...
        <button
          ...
          onClick={handleNext}
          disabled={!value}
          aria-label={t("children.nextAria")}
