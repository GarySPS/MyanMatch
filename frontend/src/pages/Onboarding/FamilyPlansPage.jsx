...
const OPTIONS = [
  { key: "fam.opt.dont",   valueEn: "Don't want children" },
  { key: "fam.opt.want",   valueEn: "Want children" },
  { key: "fam.opt.open",   valueEn: "Open to children" },
  { key: "fam.opt.unsure", valueEn: "Not sure yet" },
  { key: "fam.opt.na",     valueEn: "Prefer not to say" },
];
...
export default function FamilyPlansPage() {
  ...
  // Keep stored value in English for DB consistency
      ...
      <div className="relative bg-white/95 rounded-3xl shadow-2xl max-w-md w-full px-7 py-10 flex flex-col items-center">
        ...
        <div className="flex items-center justify-center w-full mb-7">
          <div className="w-7 h-7 rounded-full border-2 border-[#6e2263] flex items-center justify-center bg-white shadow">
            <Icons.shoppingcart className="w-5 h-5 text-[#6e2263]" />
          </div>
