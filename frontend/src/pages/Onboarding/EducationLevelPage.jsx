...
const OPTIONS = [
  { key: "edu.opt.highschool", valueEn: "High School" },
  { key: "edu.opt.undergrad",  valueEn: "Undergrad" },
  { key: "edu.opt.postgrad",   valueEn: "Postgrad" },
  { key: "edu.opt.na",         valueEn: "Prefer not to say" },
];
...
export default function EducationLevelPage() {
  ...
  // Keep stored value in English for consistency
      ...
      <div className="relative bg-white/95 rounded-3xl shadow-2xl max-w-md w-full px-7 py-10 flex flex-col items-center">
        ...
        <div className="flex items-center justify-center w-full mb-7">
          <div className="w-7 h-7 rounded-full border-2 border-[#6e2263] flex items-center justify-center bg-white shadow">
            <Icons.academiccap className="w-5 h-5 text-[#6e2263]" />
          </div>
