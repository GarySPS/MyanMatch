...
const Login = ({
    ...
    // Fake colorMode logic (replace with your own if needed)
    // If you don't use light/dark logo, just remove all colorMode checks below
